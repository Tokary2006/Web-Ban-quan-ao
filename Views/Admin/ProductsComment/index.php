                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="admin.php?page=productscomment&action=edit&id=<?= $c['id'] ?>">
                                            <i class="bx bx-edit-alt me-1"></i> Sửa/Xem chi tiết
                                        </a>
                                        <a class="dropdown-item text-danger" href="admin.php?page=productscomment&action=delete&id=<?= $c['id'] ?>" onclick="return confirm('Bạn có chắc muốn xóa?')">
