            ...
            <tr>
                ...
                <td>
                    <?php if (!empty($value['images'])): ?>
                        <img src="<?= htmlspecialchars($value['images']) ?>" width="50px" alt="Hình ảnh bài viết">
                    <?php else: ?>
                        <span>Chưa có ảnh</span>
                    <?php endif; ?>
                </td>
                <td>
                    <?php if ($value['status_enum'] == 1): ?>
                ...
                <td>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="admin.php?page=blog&action=edit&id=<?= $value['id'] ?>">
                                <i class="bx bx-edit-alt me-1 btn-success"></i> Sửa
                            </a>
                            <a class="dropdown-item" href="admin.php?page=blog&action=delete&id=<?= $value['id'] ?>" onclick="return confirm('Bạn có chắc muốn xóa?')">
